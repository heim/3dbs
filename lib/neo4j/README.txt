...
Welcome to Neo4j release 2.0.0-M06, a high-performance graph database.
...
* [Getting Started](http://docs.neo4j.org/chunked/2.0.0-M06/introduction.html)
* [The Neo4j Manual (online)](http://docs.neo4j.org/chunked/2.0.0-M06/)
